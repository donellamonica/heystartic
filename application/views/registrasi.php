<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg col-lg-6 shadow-lg my-5 mx-auto">
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Usename Anda" name="username">
